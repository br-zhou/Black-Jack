...
Blackjack Advice: I followed the Advice from the "Basic Stategy" section of the Bicycle website.
-If the dealer's upcard is good (value 7+), player is advised to stand when their total value is 17+
-If the dealer's upcard is bad (value 4-6), player is advised to stand when their total value is 12+
-If the dealer's upcard is fair (value 2-3), player is advised to stand when their total value is 13+
